class MaquinaEstadosJugador {
  ...
  public static final int idleUp = 4;//Quieto en direccion hacia arriba
  public static final int idleDown = 5;//Quieto en direccion hacia abajo
  public static final int idleRight = 6;//Quieto en direccion hacia la Derecha
  public static final int idleLeft = 7;//Quieto en direccion hacia la Izquierda
}
